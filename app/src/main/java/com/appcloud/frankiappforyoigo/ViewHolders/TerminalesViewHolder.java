...
public class TerminalesViewHolder extends RecyclerView.ViewHolder {
    ...
    LinearLayout lnCero, lnCinco, lnSinfin;
    TextView tvNombre, tvPagoInicialCero, tvCuotaMensualCero, tvPagoInicialCinco,
            tvCuotaMensualCinco, tvPagoInicialSinfin, tvCuotaMensualSinfin;
    ...
    public void bindToOferta(final Context context, final OfertaTactica oferta, View.OnClickListener listener) {
        ...
        if(oferta.getPagoInicialCero()==null || oferta.getPagoInicialCero().equals(""))
            ...
            if(tvPagoInicialCero!=null && tvCuotaMensualCero!=null)
            {
                ...
                tvCuotaMensualCero.setText(formatoCuota(oferta.getFinanciacionCero()));
            }
        }
        if(oferta.getPagoFinalCinco()==null || oferta.getPagoFinalCinco().equals(""))
            ...
            if(tvPagoInicialCinco!=null && tvCuotaMensualCinco!=null)
            {
                ...
                tvCuotaMensualCinco.setText(formatoCuota(oferta.getFinanciacionCinco()));
            }
        }
        if(oferta.getPagoFinalSinFin()==null || oferta.getPagoInicialSinFin().equals(""))
            ...
            if(tvPagoInicialSinfin!=null && tvCuotaMensualSinfin!=null)
            {
                ...
                tvCuotaMensualSinfin.setText(formatoCuota(oferta.getFinanciacionSinFin()));
            }
        }
